package com.example.calculadoradexter;
...
public class MainActivity extends AppCompatActivity {
    private Button btnUno,btnDos,btnTres,btnCuatro,btnCinco,btnSeis,btnSiete,btnOcho,btnNueve,btnCero,btnSuma,btnResta,btnMultiplica,btnIgual,btnPunto;
    private Button btnDivide,btnClean,btnBorrar;
    private String mostrar,operador,reserva;
